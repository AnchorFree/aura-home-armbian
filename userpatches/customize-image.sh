...
InstallAurahome()
{
	...
	apt update
	apt install -yyq tmux vim avahi-daemon libnss-mdns dnsmasq iptables-persistent libwebsockets8 libjansson4 libevent-2.1-6 libevent-openssl-2.1-6 libevent-pthreads-2.1-6 libbpf4.19 xml2 socat jq avahi-utils nmap python3-nmap ifplugd aura-home uuid-runtime
